    ...
    <div class="arenda" class:nonactive={SelectVehicle !== -1}>
        <div class="arenda-header">
            <div class="arenda-header__text">
                <div class="arenda-header__title">{translateText('vehicle', 'Achizitie de transport aerian')}</div>
                <div class="arenda-header__main-text">{translateText('vehicle', 'Ai venit să-ți iei aeronava personală? Destul de ciudat - ești la locul potrivit! Dacă dețineți un elicopter sau un avion personal, îl puteți genera aici.')}</div>
            </div>
        ...
        <div class="arenda-main">
            ...
            <div class="arenda-main__element">
                ...
                <div class="arenda-main__price">{item.IsSpawn ? "Chemat" : ""}</div>
