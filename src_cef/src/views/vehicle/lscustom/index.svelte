...
<div id="lscustoms">
    ...
    <div class="centerSide">
        <div class="buttonInfo">
            ...
            <div class="text">{translateText('vehicle', 'Deconectare/Înapoi')}</div>
        </div>
        <div class="buttonInfo">
    ...
    <div class="rightSide">
        <div class="spec">
            <div class="head">{translateText('vehicle', 'Caracteristici')}</div>
            <div class="lb">
                <div class="title"><i class="ic1"/>{translateText('vehicle', 'Viteză')}</div>
                <ul class="specProc">
            ...
            <div class="lb">
                <div class="title"><i class="ic2"/>{translateText('vehicle', 'Accelerare')}</div>
                <ul class="specProc">
            ...
            <div class="lb">
                <div class="title"><i class="ic3"/>{translateText('vehicle', 'Frânare')}</div>
                <ul class="specProc">
            ...
            <div class="lb">
                <div class="title"><i class="ic4"/>{translateText('vehicle', 'Tracţiune')}</div>
                <ul class="specProc">
