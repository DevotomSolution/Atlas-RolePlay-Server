<script>
    ...
    const SellInfoByType = [
        {
            title: 'Vânzarea de minerale',
            text: 'Aici puteți vinde mineralele pe care le aveți.'
        },
        {
            title: 'Vânzarea resurselor',
            text: 'Aici vă puteți vinde resursele existente.'
        }
    ];
    ...
    {#if SelectedItem !== -1}
        <div class="props-arenda">
            <div class="arenda-customize" transition:fade={{duration: 200}}>
                <div class="arenda-customize__title">Vânzare</div>
                ...
                <div class="arenda-customize__paragraph">Cantitate de vanzare (bucati)</div>
                ...
                <div class="arenda-customize__exit" on:click={() => { SelectedItem = -1; ItemAmount = 0; }}>Închide</div>
            </div>
        </div>
    {/if}
</div>