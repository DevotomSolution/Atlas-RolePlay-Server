...
<div class="newphone__rent_list" in:fade>
   ...
   <!--{#if selectedCar.time == "Аренда"}
        <div class="newphone__project_button rent">Prelungește-ți contractul de închiriere</div>
        <div class="newphone__project_button rent">Refuzați închirierea</div>
    {/if}
    <div class="newphone__project_button rent">Arată pe hartă</div>
    <div class="newphone__project_button rent">Prelungește-ți contractul de închiriere</div>
    <div class="newphone__project_button rent">Refuzați închirierea</div>
    <div class="newphone__project_button rent">Arată pe hartă</div>-->
