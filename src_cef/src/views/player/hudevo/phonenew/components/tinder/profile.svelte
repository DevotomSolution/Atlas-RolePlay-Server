<script>
    ...
    const onSave = () => {
        if (avatar == true) {
            return window.notificationAdd(4, 9, "Fotografia se încarcă", 3000);
        }
...
{#if isCreate && !isEdit}
<div class="newphone__maps_headertitleGPS newphone__project_padding16">Profilul tau:</div>
<div class="newphone__ads_list auction big">
    ...
    <div class="newphone__project_button tinder" on:click={onEdit}>Editati</div>
</div>
{:else}
    <div class="newphone__project_padding16">
        <div class="newphone__maps_headertitleGPS">Editarea profilului dvs</div>
        <div class="newphone__maps_headertitleGPS">Descriere:</div>
        ...
        <div class="newphone__maps_headertitleGPS">Caut:</div>
        ...
        <div class="newphone__project_button tinder" on:click={onSendImage}>Selectați fotografia</div>
        <div class="newphone__project_button tinder" on:click={onSave}>Salvați</div>
    </div>
{/if}
