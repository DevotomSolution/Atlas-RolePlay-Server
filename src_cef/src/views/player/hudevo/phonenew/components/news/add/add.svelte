...
<div in:fade class="box-100">
    ...
    <div class="newphone__ads_info small">
        <textarea class="newphone__ads_textarea" bind:value={text} maxlength={maxSymbol} on:focus={onInputFocus} on:blur={onInputBlur} placeholder="Câmp pentru introducerea textului publicitar..." />
