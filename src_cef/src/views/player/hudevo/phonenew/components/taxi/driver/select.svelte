...
<div in:fade class="box-100">
    ...
    <div class="newphone__maps_list">
        ...
        <div class="newphone__maps_subtitle">Destinația este deja marcată în navigatorul GPS. Plata va fi debitată automat de la client pe măsură ce călătoria avansează.</div>
