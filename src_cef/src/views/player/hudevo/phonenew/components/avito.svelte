<script>
    ...
    let newsList = [
        {
            name: "Vitaliy Zdobych",
            text: "Vând o mașină Bugatti Chiron 10.000.000$",
        ...
        {
            name: "Den Zdobich",
            text: "Vând o mașină Infernus 10.000.000$",
            price: "50000",
            url: "",
            categorie: "cars"
        },
...
<div class="newphone__rent">
    ...
    <div class="newphone__rent_content">
        ...
        {#if currentElement == "list"}
            <div class="newphone__project_button ravito" on:click={()=> currentElement = "create"}>Postați un anunț</div>
            <div class="box-center box-between newphone__project_padding20">
                <div class="newphone__maps_header m-0">Reclame:</div>
                {#if false}
        ...
        {#if currentElement == "create" && addSelector === null}
            <div class="newphone__maps_header m-top newphone__project_padding20">Postați un anunț:</div>
            <div class="newphone__ads_list">
        ...
        {#if currentElement == "filter" && addSelector === null}
            <div class="newphone__maps_header m-top newphone__project_padding20">Filtre:</div>
            ...
            <div class="box-between w-1 newphone__project_padding20">
                <div class="box-column">
                    <div class="newphone__ads_title newphone__project_padding20">Pretul:</div>
                    <input type="text" class="newphone__ads_input small" placeholder="Introduceți text" on:focus={onInputFocus} on:blur={onInputBlur}>
                </div>
                <div class="box-column">
                    <div class="newphone__ads_title newphone__project_padding20">Pret pana la:</div>
                    <input type="text" class="newphone__ads_input small" placeholder="Introduceți text" on:focus={onInputFocus} on:blur={onInputBlur}>
                </div>
            </div>
            <div class="newphone__project_button ravito">Aplica filtru</div>
            <div class="violet box-center" on:click={goToStartPage}>Înapoi</div>
        {/if}
        {#if addSelector}
            <div class="newphone__maps_header m-top newphone__project_padding20">{categorieName[addSelector]}</div>
            <div class="newphone__ads_title newphone__project_padding20">Titlu:</div>
            <input type="text" class="newphone__ads_input" placeholder="Introduceți text" on:focus={onInputFocus} on:blur={onInputBlur}>
            <div class="newphone__ads_info small">
                <textarea class="newphone__ads_textarea" placeholder="Începeți să vă scrieți mesajul"></textarea>
                <div class="newphone__ads_capture">
                    {#if false}
                        <div class="newphone__ads_gray">Adăugați o fotografie+</div>
                    {/if}
                    {#if true}
            ...
            <div class="newphone__ads_title newphone__project_padding20">Preț:</div>
            <input type="text" class="newphone__ads_input" placeholder="Introduceți text" on:focus={onInputFocus} on:blur={onInputBlur}>
            <div class="newphone__project_button ravito">Postați un anunț</div>
            <div class="violet box-center" on:click={goToStartPage}>Înapoi</div>
        {/if}
    </div>
    <HomeButton />
