...
<div class="hudevo__placetime">
    <div class="hudevo__placetime_image">
        ...
        <div class="hudevo__placetime_title">Pe net</div>
        <div class="hudevo__placetime_subtitle">{serverOnline} jucători</div>
    </div>
    {#if isWorld}
    <div class="hudevo__placetime_image">
    ...
    {#if greenZone}
        <div class="hudevo__greenzone" style="margin-bottom: -{SafeSone.y}px">
            ...
            <div class="hudevo__greenzone_text">Zona <b>Verde</b></div>
        </div>
    {/if}
</div>