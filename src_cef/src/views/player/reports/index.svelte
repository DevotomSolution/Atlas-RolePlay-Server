...
<div class="report-wrapper">
    <div class="ticketfull">
        <div class="ticketinside">
            ...
            <div class="answer">
                <p class="reporttext">Răspunsuri</p>
                <div class="boxes">
                    <div class="boxreports">
                        {#if $selected}
                        <div class="onereport">
                            <div class="reportinfo">
                                <p class="task">Sarcină</p>
                                <p class="tasknumber">NR {$selected.id}</p>
                ...
                <div class="answertoquestion">
                    <div class="textquestion">
                        <form action="javascript:void(0);">
                            <textarea class="user" onKeyPress={e => onKeyBan(e)} ref="answerBox" bind:value={answer} placeholder="Introduceți răspunsul la întrebare..."  wrap="soft" cols="30" rows="5"></textarea>
                        </form>
                    </div>
                    <div class="buttonquestion">
                        <div class="box-flex">
                            <button class="buttonone" on:click={e => onSendAnswer($selected)}>Răspuns</button>
                            <button class="buttononek" on:click={e => onReturnReport($selected)}>Întoarcere</button>
                        </div>
            ...
            <div class="template">
                ...
                <div class="texttempl">
                    <form action="">
                        <p>
                            <textarea class="user"  placeholder="Scrieți textul pentru șablon și faceți clic pe spațiul liber" cols="30" rows="5"></textarea>
                        </p>
                    </form>
                </div>
            </div>
