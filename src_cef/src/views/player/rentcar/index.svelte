<script>
    ...
    const onBuy = () => {
        if ($charMoney < GetRentCarCash (VehicleArray [SelectVehicle].Price * HourValue)) {            
            window.notificationAdd(1, 9, `Nu ai suficiente fonduri!`, 3000);
            return;
        }
...
<div id="arenda-page">
    <div class="arenda" class:nonactive={SelectVehicle !== -1}>
        <div class="arenda-header">
            <div class="arenda-header__text">
                <div class="arenda-header__title">Chirie</div>
                <div class="arenda-header__main-text">Aveți nevoie de o mașină pentru a vă deplasa? Pe tot teritoriul statului, folosind GPS, puteți găsi locuri similare care oferă o varietate de vehicule de închiriat: de la bărci și motociclete până la mașini de lux în orice culoare! Vă puteți gestiona închirierea prin intermediul telefonului; când părăsiți statul, închirierea nu va fi resetată dacă mai aveți timp plătit.</div>
            </div>
    ...
    <div class="props-arenda">
        <div class="arenda-customize" transition:fade={{duration: 200}}>
            <div class="arenda-customize__title">Chirie</div>
            ...
            <div class="arenda-customize__paragraph">Perioada de inchiriere/ora</div>
            ...
            <div class="arenda-customize__input-description">
                ...
                <div>${format("money", GetRentCarCash (VehicleArray [SelectVehicle].Price))} / ora</div>
                <div class="arenda-customize_gray">8</div>
            </div>
            {/if}
            <div class="arenda-customize__paragraph">Culoarea mașinii</div>
            ...
            <div class="arenda-customize__exit" on:click={() => SelectVehicle = -1}>Închide</div>
        </div>
    </div>
    {/if}
</div>